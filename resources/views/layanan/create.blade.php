...
<div class="flex items-center mb-8 px-2 mt-4 gap-4">
    ...
    <div>
        <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">Tambah Layanan Baru</h1>
        <p class="text-sm text-gray-500 mt-1">Isi formulir berikut untuk menambahkan daftar layanan klinik.</p>
    </div>
</div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="nama_layanan" required 
                        ...
                        placeholder="Contoh: Pembersihan Karang Gigi (Scaling)" value="{{ old('nama_layanan') }}">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="harga" required 
                            ...
                            placeholder="150000" min="0" value="{{ old('harga') }}">
                ...
                <div>
                    ...
                    <select name="parent_id" class="w-full px-5 py-3.5 rounded-2xl border border-gray-200 focus:border-orange-500 focus:ring-4 focus:ring-orange-500/20 transition-all font-semibold text-gray-800">
                        ...
                        @foreach($parents as $parent)
                            <option value="{{ $parent->id_layanan }}" {{ old('parent_id') == $parent->id_layanan ? 'selected' : '' }}>
                                {{ $parent->nama_layanan }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select name="tampil_di_booking" required class="w-full px-5 py-3.5 rounded-2xl border border-gray-200 focus:border-orange-500 focus:ring-4 focus:ring-orange-500/20 transition-all font-semibold text-gray-800">
                        <option value="1" {{ old('tampil_di_booking', '1') == '1' ? 'selected' : '' }}>Ya, Tampilkan</option>
                        <option value="0" {{ old('tampil_di_booking') == '0' ? 'selected' : '' }}>Tidak, Sembunyikan</option>
                    </select>
                ...
                <div class="pt-8 border-t border-gray-100 flex justify-end gap-3 mt-8">
                    <button type="reset" class="px-6 py-3 rounded-full text-gray-500 font-bold hover:bg-gray-50 transition-colors">Batal</button>
